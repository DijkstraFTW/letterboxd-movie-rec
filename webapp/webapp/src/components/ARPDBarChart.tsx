...
// @ts-expect-error
const ARPDBarChart = ({data, x_field, y_field}) => {
        ...
        if (active && payload && payload.length) {
            ...
            return (
                <div className="inline-block bg-gray-800 p-1.5 rounded-sm">
                    ...
                    <span className="flex flex-row items-center text-gray-500">{`released in the ${label}s`}</span>
                </div>
            );
        }
    };
